function TermsAndConditions() {
  return (
    <div className="container">
      ...
      <p>
        REZZLIST is committed to ensuring that the app is as useful and
      ...
      <p>
        The REZZLIST app stores and processes personal data that you have
        ...
        features and it could mean that the REZZLIST app won’t work properly or
        at all.
      </p>
      <p>
      ...
      <p>
        You should be aware that there are certain things that REZZLIST will not
        ...
        or provided by your mobile network provider, but REZZLIST cannot take
      ...
      <p>
        Along the same lines, REZZLIST cannot always take responsibility for the
        ...
        the Service, REZZLIST cannot accept responsibility.
      </p>
      <p>
        With respect to REZZLIST’s responsibility for your use of the app, when
        ...
        it available to you. REZZLIST accepts no liability for any loss, direct
      ...
      <p>
        ...
        to keep using the app. REZZLIST does not promise that it will always
      ...
      <p>
        ...
        do not hesitate to contact us at Steve.eubank1@gmail.com.
      </p>
      <h3>Privacy Policy</h3>
      <p>
        REZZLIST built the REZZLIST app as a Freemium app. This SERVICE is
        provided by REZZLIST at no cost and is intended for use as is.
      </p>
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which are accessible at REZZLIST unless otherwise
      ...
      <p>
        ...
        not hesitate to contact us at Steve.eubank1@gmail.com.
      </p>
    </div>
  );
}
